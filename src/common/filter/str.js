...
//把一个类似于“中国 上海市 浦东新区”这种字符串转换成城市名-> “上海”
export function cityName(str) {

  if (!str) {
    return ""
  } else if (startWith(str, "中国")) {

    if (containStr(str, "重庆")) {
      return "重庆";
    } else if (containStr(str, "上海")) {
      return "上海";
    } else if (containStr(str, "北京")) {
      return "北京";
    } else if (containStr(str, "天津")) {
      return "天津";
    } else if (endWith(str, "市")) {
